/**
  * mizhu为整个alert对象 使用方法必须引入css/style.css ,自身js,jquery.js 并且本身js必须在jquery.js之下
  */
var mizhu = new function() {
	this.width = $(window).width() * 0.25;
	this.height = 192;
    ...
    /**
      * 确认选项框 
      * title 标题框 message内容主题 selected 选择是的返回值执行参数 默认第一个参数为flag
      */
	...
	function confirmFeedBack(flag){
	   return flag;
	}
	

    /**
      *警告框  title 标题框 message内容主题 ico内容中的图片 以png的形式放入images中，这里传参为文件名不带后缀
      */
    ...
    /**
      *提示栏 message内容 time消失时间 默认3000ms
      */
