/*
  ...
  只需在页面上引用即可该JS即可
  为了替换方便以前的exporting.js,把toolbox改名为exporting.js
   以前的exporting改名为toolbox.js
*/
...
(function() {
    ...
    v.exporting={
        ...
        buttons:{
            exportButton:{//导出按钮
                symbol:"url("+projectPath+"/plugs/highChart/js/modules/image/download.gif)",
                x:-10,
                symbolFill:"#A8BF77",
            ...
            toTbButton:{//自定义按钮转换为表格
                symbol:"url("+projectPath+"/plugs/highChart/js/modules/image/table.gif)",
                x:-40,
                symbolFill:"#A8BF77",
                hoverSymbolFill:"#768F3E",
                _id:"exportButton",
                _titleKey:"chartToTable",
                onclick:function(){SolveAll()}
            },
             toPieButton:{//自定义按钮转换为为线图
                symbol:"url("+projectPath+"/plugs/highChart/js/modules/image/pie.gif)",
                x:-70,
                symbolFill:"#A8BF77",
                hoverSymbolFill:"#768F3E",
                _id:"exportButton",
                _titleKey:"chartToPie",
                onclick:function(){changeType("pie")}
            },
             toColButton:{//自定义按钮转换为为柱状图
                symbol:"url("+projectPath+"/plugs/highChart/js/modules/image/column.gif)",
                x:-100,
                symbolFill:"#A8BF77",
                hoverSymbolFill:"#768F3E",
                _id:"exportButton",
                _titleKey:"chartToColumn",
                onclick:function(){changeType("column")}
            },
             toLineButton:{//自定义按钮转换为为线图
                symbol:"url("+projectPath+"/plugs/highChart/js/modules/image/line.gif)",
                x:-130,
                symbolFill:"#A8BF77",
                hoverSymbolFill:"#768F3E",
                _id:"exportButton",
                _titleKey:"chartToLine",
                onclick:function(){changeType("line")}
            },
             filterButton:{//自定义按钮条件过滤
                symbol:"url("+projectPath+"/plugs/highChart/js/modules/image/filter.gif)",
                x:-160,
                symbolFill:"#A8BF77",
                hoverSymbolFill:"#768F3E",
                _id:"exportButton",
                _titleKey:"filterCond",
                onclick:function(){setEleCond()}
            }
        }
