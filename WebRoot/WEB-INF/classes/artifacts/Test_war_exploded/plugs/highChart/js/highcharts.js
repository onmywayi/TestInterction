...
(function () {
	...
	function Ia(a, b) {
		for (var c = "{", d = !1, e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1; ) {
			...
			if (d) {
				...
				if (f.length) {
					f = f.join(":"), g = /\.([0-9])/, h = L.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e = Ga(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : "")) : e = bb(f, e);
				}
			}
			j.push(e);
			a = a.slice(c + 1);
	...
	function Cb() {
		...
		Ra = (a && L.global.timezoneOffset || 0) * 60000;
		...
		return {get:function (c) {
			...
			if (d) {
				...
				if (ya(a) && a !== 0) {
					var c;
					for (c = 0; c < 3; c++) {
						b[c] += x(a * 255), b[c] < 0 && (b[c] = 0), b[c] > 255 && (b[c] = 255);
					}
				}
			}
			return this;
	...
	ta.prototype = {init:function (a, b) {
		...
		if (ga(a)) {
			c = a, h === "circle" ? c = {x:"cx", y:"cy"}[c] || c : c === "strokeWidth" && (c = "stroke-width"), q = z(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && c !== "fill" && (q = parseFloat(q));
		} else {
			for (c in a) {
				if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
													...
													if (c === "dashstyle") {
														...
														if (c === "width") {
															...
															if (c === "align") {
																...
																if (c === "title") {
																	e = g.getElementsByTagName("title")[0], e || (e = y.createElementNS(Da, "title"), g.appendChild(e)), e.textContent = d;
																}
															}
														}
													}
					...
					if (c === "stroke-width" || c === "stroke") {
						...
						if (this.stroke && this["stroke-width"]) {
							z(g, "stroke", this.stroke), z(g, "stroke-width", this["stroke-width"]), this.hasStroke = !0;
						} else {
		...
		if (!a) {
			...
			if (b.isSVG) {
				...
				if (e) {
					a.width = N(d * ba(g)) + N(c * W(g)), a.height = N(d * W(g)) + N(c * ba(g));
				}
			}
			this.bBox = a;
			h && (b.cache[h] = a);
		...
		if (a) {
			...
			for (e = 1; e <= i; e++) {
				...
				if (c) {
					z(f, "height", t(z(f, "height") - h, 0)), f.cutHeight = h;
				}
	...
	pa.prototype = {Element:ta, init:function (a, b, c, d, e) {
		...
		p(e, function (e, f) {
			...
			p(l, function (e) {
				if (e !== "" || l.length === 1) {
					...
					if (e !== " " && (o.appendChild(y.createTextNode(e)), m ? q.dx = 0 : q.x = i, z(o, q), !m && f && (!X && d && D(o, {display:"block"}), z(o, "dy", n(o), hb && o.offsetHeight)), b.appendChild(o), m++, k)) {
						for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), q = e.length > 1 && j.whiteSpace !== "nowrap", r, t, s = a._clipHeight, A = [], v = n(), u = 1; q && (e.length || A.length); ) {
							delete a.bBox, r = a.getBBox(), t = r.width, !X && c.forExport && (t = c.measureSpanWidth(o.firstChild.data, a.styles)), r = t > k, !r || e.length === 1 ? (e = A, A = [], e.length && (u++, s && u * v > s ? (e = ["..."], a.attr("title", a.textStr)) : (o = y.createElementNS(Da, "tspan"), z(o, {dy:v, x:i}), p && z(o, "style", p), b.appendChild(o), t > k && (k = t)))) : (o.removeChild(o.firstChild), A.unshift(e.pop())), e.length && o.appendChild(y.createTextNode(e.join(" ").replace(/- /g, "-")));
						}
					}
				}
			});
		...
		var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, m, n, q, o, p, a = {x1:0, y1:0, x2:0, y2:1}, e = w({"stroke-width":1, stroke:"#CCCCCC", fill:{linearGradient:a, stops:[[0, "#FEFEFE"], [1, "#F6F6F6"]]}, r:2, padding:5, style:{color:"black"}}, e);
		n = e.style;
		delete e.style;
		...
		if (g) {
			...
			return f.test(a) ? (e = wa(a), z(b, c + "-opacity", e.get("a")), e.get("rgb")) : (b.removeAttribute(c + "-opacity"), a);
		}
		...
		function j() {
			...
			if (y) {
				if (!o) {
					a = v(-t * P), b = h ? -xa : 0, n.box = o = d ? m.symbol(d, a, b, n.width, n.height, A) : m.rect(a, b, n.width, n.height, 0, A[Lb]), o.attr("fill", O).add(n);
				}
		...
		function k() {
			...
			if (r(Va) && K && (a === "center" || a === "right")) {
				b += {center:0.5, right:1}[a] * (Va - K.width);
			}
	...
	if (!X && !ca) {
		Q.VMLElement = da = {init:function (a, b) {
			...
			c.push(" style=\"", d.join(""), "\"/>");
			if (b) {
				c = e || b === "span" || b === "img" ? c.join("") : a.prepVML(c), this.element = V(c);
			}
			this.renderer = a;
			this.attrSetters = {};
		}, add:function (a) {
			...
			var c, d, e, f = this.element || {}, g = f.style, h = f.nodeName, i = this.renderer, j = this.symbolName, k, l = this.shadows, m, n = this.attrSetters, q = this;
			ga(a) && r(b) && (c = a, a = {}, a[c] = b);
			if (ga(a)) {
							...
							if (c === "d") {
								...
								if (c === "visibility") {
									...
									if (c === "zIndex") {
										...
										if (va(c, ["x", "y", "width", "height"]) !== -1) {
											this[c] = d, c === "x" || c === "y" ? c = {x:"left", y:"top"}[c] : d = t(0, d), this.updateClipping ? (this[c] = d, this.updateClipping()) : g[c] = d, m = !0;
										} else {
											if (c === "class" && h === "DIV") {
												f.className = d;
											} else {
												if (c === "stroke") {
													...
													if (c === "stroke-width" || c === "strokeWidth") {
														f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, ya(d) && (d += "px");
													} else {
														if (c === "dashstyle") {
															(f.getElementsByTagName("stroke")[0] || V(i.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid", this.dashstyle = d, m = !0;
														} else {
															if (c === "fill") {
																if (h === "SPAN") {
																	g.color = d;
																	...
																	if (h !== "IMG") {
																		f.filled = d !== O ? !0 : !1, d = i.color(d, f, c, this), c = "fillcolor";
																	}
																}
															} else {
																if (c === "opacity") {
																	...
																	if (h === "shape" && c === "rotation") {
																		this[c] = f.style[c] = d, f.style.left = -v(ba(d * Ca) + 1) + "px", f.style.top = v(W(d * Ca)) + "px";
																	} else {
		...
		var ea = {Element:da, isIE8:ua.indexOf("MSIE 8.0") > -1, init:function (a, b, c, d) {
			...
			if (i) {
				...
				if (c === "fill") {
					if (i === "gradient") {
						c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, P = "angle=\"" + (90 - T.atan((m - a) / (n - c)) * 180 / la) + "\"", v();
					} else {
				...
				if (g.test(a) && b.tagName !== "IMG") {
					f = wa(a), h = ["<", c, " opacity=\"", f.get("a"), "\"/>"], V(this.prepVML(h), null, null, b), j = f.get("rgb");
				} else {
	...
	Sa.prototype = {addLabel:function () {
		...
		if (m && t) {
			s === "inside" && (t = -t), d.opposite && (t = -t), h = this.getMarkPath(H, w, t, m * A, g, f), n ? n.animate({d:h, opacity:c}) : this.mark = f.path(h).attr({stroke:r, "stroke-width":m, opacity:c}).add(d.axisGroup);
		}
		if (i && !isNaN(H)) {
			i.xy = w = this.getLabelPosition(H, w, i, g, k, y, a, v), this.isFirst && !this.isLast && !o(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !o(e.showLastLabel, 1) ? x = !1 : !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && (x = this.handleOverflow(a, w)), v && a % v && (x = !1), x && !isNaN(w.y) ? (w.opacity = c, i[this.isNew ? "attr" : "animate"](w), this.isNew = !1) : i.attr("y", -9999);
		}
	}, destroy:function () {
		Oa(this, this.axis);
	}};
	...
	Q.PlotLineOrBand.prototype = {render:function () {
		...
		if (h) {
			if (q = b.getPlotLinePath(l, h), d = {stroke:K, "stroke-width":h}, m) {
				d.dashstyle = m;
			}
		} else {
			if (k) {
				if (j = t(j, b.min - d), i = E(i, b.max + d), q = b.getPlotBandPath(j, i, e), d = {fill:K}, e.borderWidth) {
		...
		if (n) {
			if (q) {
				n.animate({d:q}, null, n.onGetPath);
			} else {
		...
		if (f && r(f.text) && q && q.length && b.width > 0 && b.height > 0) {
			...
			if (!g) {
				a.label = g = v.text(f.text, 0, 0, f.useHTML).attr({align:f.textAlign || f.align, rotation:f.rotation, zIndex:s}).css(f.style).add();
			}
			b = [q[1], q[4], o(q[6], q[1])];
			q = [q[2], q[5], o(q[7], q[2])];
			c = Na(b);
	...
	ka.prototype = {defaultOptions:{dateTimeLabelFormats:{millisecond:"%H:%M:%S.%L", second:"%H:%M:%S", minute:"%H:%M", hour:"%H:%M", day:"%e. %b", week:"%e. %b", month:"%b '%y", year:"%Y"}, endOnTick:!1, gridLineColor:"#C0C0C0", labels:F, lineColor:"#C0D0E0", lineWidth:1, minPadding:0.01, maxPadding:0.01, minorGridLineColor:"#E0E0E0", minorGridLineWidth:1, minorTickColor:"#A0A0A0", minorTickLength:2, minorTickPosition:"outside", startOfWeek:1, startOnTick:!1, tickColor:"#C0D0E0", tickLength:5, tickmarkPlacement:"between", tickPixelInterval:100, tickPosition:"outside", tickWidth:1, title:{align:"middle", style:{color:"#4d759e", fontWeight:"bold"}}, type:"linear"}, defaultYAxisOptions:{endOnTick:!0, gridLineWidth:1, tickPixelInterval:72, showLastLabel:!0, labels:{x:-8, y:3}, lineWidth:0, maxPadding:0.05, minPadding:0.05, startOnTick:!0, tickWidth:0, title:{rotation:270, text:"Values"}, stackLabels:{enabled:!1, formatter:function () {
		...
		if (this.isLog) {
			this.val2lin = za, this.lin2val = ha;
		}
		...
		if (h) {
			...
			if (c) {
				...
				if (d) {
					...
					if (f && a >= 1000) {
						for (; f-- && g === u; ) {
							c = Math.pow(1000, f + 1), a >= c && e[f] !== null && (g = Ga(b / c, -1) + e[f]);
						}
					}
				}
			}
		}
		g === u && (g = b >= 10000 ? Ga(b, 0) : Ga(b, -1, u, ""));
		return g;
			...
			if (c.visible || !b.options.chart.ignoreHiddenSeries) {
				...
				if (a.isXAxis) {
					if (d = c.xData, d.length) {
						a.dataMin = E(o(a.dataMin, d[0]), Na(d)), a.dataMax = t(o(a.dataMax, d[0]), Ba(d));
					}
				} else {
					c.getExtremes();
					e = c.dataMax;
					c = c.dataMin;
					if (r(c) && r(e)) {
						a.dataMin = E(o(a.dataMin, c), c), a.dataMax = t(o(a.dataMax, e), e);
					}
					if (r(d)) {
						if (a.dataMin >= d) {
		...
		if (e) {
			!a && E(b.min, o(b.dataMin, b.min)) <= 0 && oa(10, 1), b.min = aa(za(b.min)), b.max = aa(za(b.max));
		}
		if (b.range && r(b.max)) {
		...
		if (!h) {
			e = a[0], f = a[a.length - 1], h = b.minPointOffset || 0, d.startOnTick ? b.min = e : b.min - h > e && a.shift(), d.endOnTick ? b.max = f : b.max + h < f && a.pop(), a.length === 1 && (d = N(b.max || 1) * 0.001, b.min -= d, b.max += d);
		}
		...
		if (!a.axisGroup) {
			a.gridGroup = c.g("grid").attr({zIndex:d.gridZIndex || 1}).add(), a.axisGroup = c.g("axis").attr({zIndex:d.zIndex || 2}).add(), a.labelGroup = c.g("axis-labels").attr({zIndex:q.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add();
		}
		if (j || a.isLinked) {
			...
			if (a.horiz && !a.staggerLines && x && !q.rotation) {
				for (v = a.reversed ? [].concat(e).reverse() : e; w < x; ) {
					...
					for (q = 0; q < v.length; q++) {
						z = v[q], H = (H = f[z].label && f[z].label.getBBox()) ? H.width : 0, A = q % w, H && (z = a.translate(z), j[A] !== u && z < j[A] && (y = !0), j[A] = z + H);
					}
					if (y) {
						w++;
					} else {
			...
			if (a.staggerLines) {
				qa *= a.staggerLines, a.labelOffset = qa;
			}
		} else {
			for (v in f) {
		...
		if (n && n.text && n.enabled !== !1) {
			if (!a.axisTitle) {
				a.axisTitle = c.text(n.text, 0, 0, n.useHTML).attr({zIndex:7, rotation:n.rotation || 0, align:n.textAlign || {low:"left", middle:"center", high:"right"}[n.align]}).addClass("highcharts-" + this.coll.toLowerCase() + "-title").css(n.style).add(a.axisGroup), a.axisTitle.isNew = !0;
			}
			if (b) {
				k = a.axisTitle.getBBox()[g ? "height" : "width"], m = o(n.margin, g ? 5 : 10), l = n.offset;
			}
		...
		if (s || h) {
			if (a.minorTickInterval && !a.categories && p(a.getMinorTickPositions(), function (b) {
				...
				if (!h || b >= a.min && b <= a.max) {
					l[b] || (l[b] = new Sa(a, b)), v && l[b].isNew && l[b].render(c, !0, 0.1), l[b].render(c, !1, 1);
				}
			}), K && a.min === 0 && (l[-1] || (l[-1] = new Sa(a, -1, null, !0)), l[-1].render(-1))), o && p(i, function (b, c) {
				if (c % 2 === 0 && b < a.max) {
					n[b] || (n[b] = new Q.PlotLineOrBand(a)), x = b + K, H = i[c + 1] !== u ? i[c + 1] + K : a.max, n[b].options = {from:g ? ha(x) : x, to:g ? ha(H) : H, color:o}, n[b].render(), n[b].isActive = !0;
				}
			}), !a._addedPlotLB) {
		...
		if (t) {
			b = a.getLinePath(t), a.axisLine ? a.axisLine.animate({d:b}) : a.axisLine = e.path(b).attr({stroke:f.lineColor, "stroke-width":t, zIndex:7}).add(a.axisGroup), a.axisLine[w ? "show" : "hide"]();
		}
		if (k && w) {
		...
		if (this.crosshair) {
			if ((r(b) || !o(this.crosshair.snap, !0)) === !1) {
				this.hideCrosshair();
			} else {
	...
	ka.prototype.getTimeTicks = function (a, b, c, d) {
		...
		if (r(b)) {
			...
			if (j >= B.minute) {
				i[Db](j >= B.hour ? 0 : k * S(i[pb]() / k));
			}
			if (j >= B.hour) {
				i[Eb](j >= B.day ? 0 : k * S(i[qb]() / k));
			}
			if (j >= B.day) {
				i[sb](j >= B.month ? 1 : k * S(i[Xa]() / k));
			}
			j >= B.month && (i[Fb](j >= B.year ? 0 : k * S(i[eb]() / k)), h = i[fb]());
			j >= B.year && (h -= h % k, i[Gb](h));
			if (j === B.week) {
				i[sb](i[Xa]() - i[rb]() + o(d, 1));
			}
			b = 1;
			Ra && (i = new Date(i.getTime() + Ra));
			h = i[fb]();
			for (var d = i.getTime(), l = i[eb](), m = i[Xa](), n = g ? Ra : (86400000 + i.getTimezoneOffset() * 60000) % 86400000; d < c; ) {
		...
		if (a >= 0.5) {
			...
			if (a >= 0.08) {
				for (var f = S(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
					i = e.length;
					for (h = 0; h < i && !l; h++) {
						j = za(ha(f) * e[h]), j > b && (!d || k <= c) && g.push(k), k > c && (l = !0), k = j;
					}
				}
			} else {
				if (b = ha(b), c = ha(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = o(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = nb(a, null, mb(a)), g = Ua(this.getLinearTickPositions(a, b, c), za), !d) {
	...
	Wa.prototype = {init:function (a, b) {
		...
		if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
			...
			for (j = 0; j < i; j++) {
				if (c[j].visible && c[j].options.enableMouseTracking !== !1 && !c[j].noSharedTooltip && c[j].singularTooltips !== !0 && c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) && e.series) {
					e._dist = N(l - e.clientX), k = E(k, e._dist), f.push(e);
				}
			}
			for (i = f.length; i--; ) {
		...
		if (d && !this._onDocumentMouseMove) {
			this._onDocumentMouseMove = function (a) {
				if (r(fa)) {
					Y[fa].pointer.onDocumentMouseMove(a);
				}
		...
		if (a) {
			...
			if (this._onDocumentMouseMove) {
				U(y, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null;
			}
			p(b.axes, function (a) {
				a.hideCrosshair();
			});
		...
		a.cancelBubble = !0;
		if (!b.cancelClick) {
			c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, s(c, {pageX:g.left + d + (f ? b.plotWidth - i : h), pageY:g.top + e + (f ? b.plotHeight - h : i)}), I(c.series, "click", s(a, {point:c})), b.hoverPoint && c.firePointEvent("click", a)) : (s(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && I(b, "click", a));
		}
	...
	s(Q.Pointer.prototype, {pinchTranslate:function (a, b, c, d, e, f, g, h) {
		...
		var b = this, c = b.chart, d = b.pinchDown, e = c.tooltip && c.tooltip.options.followTouchMove, f = a.touches, g = f.length, h = b.lastValidTouch, i = b.zoomHor || b.pinchHor, j = b.zoomVert || b.pinchVert, k = i || j, l = b.selectionMarker, m = {}, n = g === 1 && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || c.runChartClick), q = {};
		...
		if (a.type === "touchstart") {
			...
			if (d.length) {
				if (!l) {
					b.selectionMarker = l = s({destroy:Ea}, c.plotBox);
				}
	...
	if (G.PointerEvent || G.MSPointerEvent) {
		var ra = {}, zb = !!G.PointerEvent, Wb = function () {
			...
			for (a in ra) {
				ra.hasOwnProperty(a) && b.push({pageX:ra[a].pageX, pageY:ra[a].pageY, target:ra[a].target});
			}
			return b;
		}, Ab = function (a, b, c, d) {
			a = a.originalEvent || a;
			if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && Y[fa]) {
				d(a), d = Y[fa].pointer, d[b]({type:c, target:a.currentTarget, preventDefault:Ea, touches:Wb()});
			}
		};
	...
	lb.prototype = {init:function (a, b) {
		...
		this.options = b;
		if (b.enabled) {
			c.baseline = x(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = w(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.symbolWidth = o(b.symbolWidth, 16), c.pages = [], c.render(), C(c.chart, "endResize", function () {
				c.positionCheckboxes();
			});
		}
	}, colorizeItem:function (a, b) {
		var c = this.options, d = a.legendItem, e = a.legendLine, f = a.legendSymbol, g = this.itemHiddenStyle.color, c = b ? c.itemStyle.color : g, h = b ? a.legendColor || a.color || "#CCC" : g, g = a.options && a.options.marker, i = {stroke:h, fill:h}, j;
		...
		if (b) {
			c = b.translateY, p(this.allItems, function (e) {
				var f = e.checkbox, g;
				f && (g = c + f.y + (a || 0) + 3, D(f, {left:b.translateX + e.legendItemWidth + f.x - 20 + "px", top:g + "px", display:g > c - 6 && g < c + d - 6 ? "" : O}));
			});
		}
		...
		if (!r) {
			a.legendGroup = c.g("legend-item").attr({zIndex:1}).add(this.scrollGroup), s.drawLegendSymbol(this, a), a.legendItem = r = c.text(d.labelFormat ? Ia(d.labelFormat, a) : d.labelFormatter.call(a), l ? f + g : -g, this.baseline, x).css(w(a.visible ? h : i)).attr({align:l ? "left" : "right", zIndex:2}).add(a.legendGroup), this.setItemEvents && this.setItemEvents(a, r, x, h, i), this.colorizeItem(a, a.visible), u && this.createCheckboxForItem(a);
		}
		c = r.getBBox();
		f = a.legendItemWidth = d.itemWidth || a.legendItemWidth || f + g + c.width + k + (u ? 20 : 0);
		this.itemHeight = g = v(a.legendItemHeight || c.height);
		if (e && this.itemX - p + f > (m || b.chartWidth - 2 * j - p - d.x)) {
			this.itemX = p, this.itemY += q + this.lastLineHeight + n, this.lastLineHeight = 0;
		}
		...
		if (l || m) {
			...
			if (i) {
				...
				a.box = i = c.rect(0, 0, g, h, j.borderRadius, l || 0).attr({stroke:j.borderColor, "stroke-width":l || 0, fill:m || O}).add(d).shadow(j.shadow), i.isNew = !0;
			}
			i[f ? "show" : "hide"]();
		}
		a.legendWidth = g;
	...
	Ya.prototype = {init:function (a, b) {
		...
		if (c && (c.css({width:(f.width || g) + "px"}).align(s({y:15}, f), !1, "spacingBox"), !f.floating && !f.verticalAlign)) {
		...
		if (k) {
			f ? f.animate(r) : this.plotBackground = b.rect(q, o, p, t, 0).attr({fill:k}).add().shadow(a.plotShadow);
		}
		if (l) {
		...
		if (m) {
			g ? g.animate(g.crisp({x:q, y:o, width:p, height:t})) : this.plotBorder = b.rect(q, o, p, t, 0, -m).attr({stroke:a.plotBorderColor, "stroke-width":m, fill:O, zIndex:1}).add();
		}
		this.isDirtyBox = !1;
	...
	M.prototype = {isCartesian:!0, type:"line", pointClass:Fa, sorted:!0, requireSorting:!0, pointAttrToOptions:{stroke:"lineColor", "stroke-width":"lineWidth", fill:"fillColor", r:"radius"}, axisTypes:["xAxis", "yAxis"], colorCounter:0, parallelArrays:["x", "y"], init:function (a, b) {
			...
			if (q && h > q) {
				...
				if (ya(k)) {
					...
					if (La(k)) {
						if (s) {
							for (c = 0; c < h; c++) {
								i = a[c], t[c] = i[0], r[c] = i.slice(1, s + 1);
							}
						} else {
							for (c = 0; c < h; c++) {
								i = a[c], t[c] = i[0], r[c] = i[1];
							}
						}
					} else {
						oa(12);
				...
				for (c = 0; c < h; c++) {
					if (a[c] !== u && (i = {series:e}, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c), m && i.name)) {
						l.names[i.x] = i.name;
					}
				}
			}
		...
		for (h = b.length - 1; h >= 0; h--) {
			d = b[h] - b[h - 1], d > 0 && (g === u || d < g) ? g = d : d < 0 && this.requireSorting && oa(15);
		}
		this.cropped = f;
		this.cropStart = e;
		...
		for (m = 0; m < g; m++) {
			i = h + m, j ? l[m] = (new f).init(this, [d[m]].concat(na(e[m]))) : (b[i] ? k = b[i] : a[i] !== u && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k);
		}
		if (b && (g !== (c = b.length) || j)) {
			for (m = 0; m < c; m++) {
				if (m === h && !j && (m += g), b[m]) {
		...
		for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || ya(i), k = a.threshold, a = 0; a < g; a++) {
			...
			if (b && this.visible && p && p[m]) {
				p = p[m], n = p.points[this.index], q = n[0], n = n[1], q === 0 && (q = o(k, e.min)), e.isLog && q <= 0 && (q = null), l.total = l.stackTotal = p.total, l.percentage = p.total && l.y / p.total * 100, l.stackY = n, p.setOffset(this.pointXOffset || 0, this.barW || 0);
			}
		...
		if (l.enabled || this._hasPointMarkers) {
			for (f = b.length; f--; ) {
				if (g = b[f], d = S(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled === u || i.enabled, n = c.isInsidePlot(v(d), e, c.inverted), a && e !== u && !isNaN(e) && g.y !== null) {
					if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = o(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) {
						k.attr({visibility:n ? "inherit" : "hidden"}).animate(s({x:d - h, y:e - h}, k.symbolName ? {width:2 * h, height:2 * h} : {}));
					} else {
						if (n && (h > 0 || j)) {
		...
		p(a.axisTypes || [], function (b) {
			if (i = a[b]) {
				ia(i.series, a), i.isDirty = i.forceRedraw = !0;
			}
		});
		...
		p(c, function (c, h) {
			...
			if (l) {
				...
				if (d && g.length) {
					l = {stroke:c[1], "stroke-width":d, fill:O, zIndex:1}, e ? l.dashstyle = e : f && (l["stroke-linecap"] = l["stroke-linejoin"] = "round"), a[k] = a.chart.renderer.path(g).attr(l).add(a.group).shadow(!h && b.shadow);
				}
			}
		});
	}, clipNeg:function () {
		...
		if (b.xAxis) {
			C(c, "resize", a), C(b, "destroy", function () {
				U(c, "resize", a);
			}), a(), b.invertGroups = a;
		}
		...
		p([b, "-" + b], function (b) {
			...
			for (var f = d.length, g, h; f--; ) {
				if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index], g = e) {
					h = h.total ? 100 / h.total : 0, g[0] = aa(g[0] * h), g[1] = aa(g[1] * h), a.stackedYData[f] = g[1];
				}
			}
		});
	};
	s(Ya.prototype, {addSeries:function (a, b, c) {
		...
		if (!c) {
			this.loadingDiv = c = V(Ja, {className:"highcharts-loading"}, s(d.style, {zIndex:10, display:O}), this.container), this.loadingSpan = V("span", null, d.labelStyle, c);
		}
		this.loadingSpan.innerHTML = a || b.lang.loading;
		if (!this.loadingShown) {
			D(c, {opacity:0, display:"", left:this.plotLeft + "px", top:this.plotTop + "px", width:this.plotWidth + "px", height:this.plotHeight + "px"}), jb(c, {opacity:d.style.opacity}, {duration:d.showDuration || 0}), this.loadingShown = !0;
		}
	...
	var ma = ja(M, {type:"area", getSegments:function () {
		...
		if (this.options.stacking && !this.cropped) {
			...
			p(c, function (a) {
				if (!k || g[a] && g[a].y !== null) {
					g[a] ? b.push(g[a]) : (h = d.translate(a), l = f[a].percent ? f[a].total ? f[a].cum * 100 / f[a].total : 0 : f[a].cum, i = e.toPixels(l, !0), b.push({y:null, plotX:h, clientX:h, plotY:i, yBottom:i, onMouseOver:Ea}));
				}
			});
			b.length && a.push(b);
		} else {
	...
	ea = ja(M, {type:"column", pointAttrToOptions:{stroke:"borderColor", "stroke-width":"borderWidth", fill:"color", r:"borderRadius"}, cropShoulder:0, trackerGroups:["group", "dataLabelsGroup"], negStacks:!0, init:function () {
		...
		p(this.points, function (a) {
			...
			s && (r -= 1, c += 1);
			a.shapeType = "rect";
			a.shapeArgs = {x:q, y:r, width:p, height:c};
		});
		...
		p(a.points, function (f) {
			...
			if (g !== u && !isNaN(g) && f.y !== null) {
				e = f.shapeArgs, h ? (ab(h), h[a.points.length < d ? "animate" : "attr"](w(e))) : f.graphic = c[f.shapeType](e).attr(f.pointAttr[f.selected ? "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius);
			} else {
				if (h) {
					f.graphic = h.destroy();
				}
	...
	R = {type:"pie", isCartesian:!1, pointClass:ja(Fa, {init:function () {
		...
		for (m = 0; m < n; m++) {
			...
			g = j + b * i;
			p.shapeType = "arc";
			p.shapeArgs = {x:a[0], y:a[1], r:a[2] / 2, innerR:a[3] / 2, start:v(f * 1000) / 1000, end:v(g * 1000) / 1000};
			h = (g + f) / 2;
				...
				for (H = 2; H--; ) {
					...
					if (l > 0) {
						...
						for (A = 0; A < G; A++) {
							...
							var O, L;
							for (L = 0; L < u; L++) {
								O = N(b[L] - w[1]), O < c && (c = O, C = L);
							}
							if (C < A && b[A] !== null) {
								C = A;
							} else {
								for (u < G - A + C && b[A] !== null && (C = u - G + A); b[C] === null; ) {
									C++;
								}
							}
							I.push({i:C, y:b[C]});
					...
					for (A = 0; A < G; A++) {
						...
						c = w[1];
						if (l > 0) {
							if (u = I.pop(), C = u.i, B = u.y, c > B && b[C + 1] !== null || c < B && b[C - 1] !== null) {
								B = c;
							}
						} else {
							B = c;
	...
	R = Q.TrackerMixin = {drawTrackerPoint:function () {
		...
		}, o = "rgba(192,192,192," + (X ? 0.0001 : 0.002) + ")";
		if (e && !c) {
			for (m = e + 1; m--; ) {
	...
	s(Fa.prototype, {select:function (a, b) {
		...
		if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && !i.enabled) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
			if (this.graphic) {
				f = g && this.graphic.symbolName && n[a].r, this.graphic.attr(w(n[a], f ? {x:c - f, y:d - f, width:2 * f, height:2 * f} : {}));
			} else {
				if (a && i) {
					if (f = i.radius, l = l.symbol || e.symbol, k && k.currentSymbol !== l && (k = k.destroy()), k) {
						k[b ? "animate" : "attr"]({x:c - f, y:d - f});
					} else {
						e.stateMarkerGraphic = k = m.renderer.symbol(l, c - f, d - f, 2 * f, 2 * f).attr(n[a]).add(e.markerGroup), k.currentSymbol = l;
					}
				}
				if (k) {
		...
		if (!(this.options.enableMouseTracking === !1 || this.singularTooltips)) {
			...
			for (i = 0; i < a; i++) {
				if (e = b[i], c = e.x, c >= f.min && c <= f.max) {
					h = b[i + 1];
					c = d === u ? 0 : d + 1;
					for (d = b[i + 1] ? E(t(0, S((e.clientX + (h ? h.wrappedClientX || h.clientX : g)) / 2)), g) : g; c >= 0 && c <= d; ) {
						j[c++] = e;
					}
				}
			}
	...
	s(Q, {Axis:ka, Chart:Ya, Color:wa, Point:Fa, Tick:Sa, Renderer:Za, Series:M, SVGElement:ta, SVGRenderer:pa, arrayMin:Na, arrayMax:Ba, charts:Y, dateFormat:bb, format:Ia, pathAnim:ub, getOptions:function () {
		return L;
